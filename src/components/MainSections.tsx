  ...
  const images = [
    {
      ...
      description: "Современные стенды для комплексных испытаний материалов",
      equipment: [
    ...
    },
    {
      ...
      title: "Прецизионное оборудование",
      description: "Высокоточные измерительные комплексы",
      equipment: [
    ...
    },
    {
      ...
      title: "Производственная лаборатория",
      description: "Комплексное испытательное оборудование в работе",
      equipment: [
